...
public class MainViewModel extends BaseViewModel {
    ...
    private LiveData<String> mRepositoryData = Transformations.switchMap(mKeyword, new Function<String, LiveData<String>>() {
        ...
        public LiveData<String> apply(String input) {
            LogUtils.i("LiveData --> MainViewModel BaseRepository转换，这是viewModel需要的数据");
            return new MainRepository(MainViewModel.this).getMainData(input);
//                    BaseRepository.getData(MainViewModel.this, input);
        }
    });
