    ...
    public static void info(Context context, String msg) {
        switch (TOAST_STYLE) {
            ...
            case 1:
                ...
                Notification.show(context, "ONES", msg, R.drawable.notification_icon_info);
                break;
            default:
                break;
        }
...
//                msgTextInfo.setFontColor(Color.rgb(96, 108, 87));
                ...
                titleTextInfo.setBold(true);
                DialogSettings.titleTextInfo = titleTextInfo;
                Notification.show(context, "ONES", msg, R.drawable.notification_icon_success);
                break;
            default:
                break;
    ...
    public static void error(Context context, String msg) {
        switch (TOAST_STYLE) {
            ...
            case 1:
                ...
                titleTextInfo.setBold(true);
                DialogSettings.titleTextInfo = titleTextInfo;
                Notification.show(context, "ONES", msg, R.drawable.notification_icon_error);
                break;
            default:
                break;
    ...
    public static void warning(Context context, String msg) {
        switch (TOAST_STYLE) {
            ...
            case 1:
                ...
                titleTextInfo.setBold(true);
                DialogSettings.titleTextInfo = titleTextInfo;
                Notification.show(context, "ONES", msg,  R.drawable.notification_icon_warn);
                break;
            default:
                break;
