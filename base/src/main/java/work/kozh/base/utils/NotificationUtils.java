...
public class NotificationUtils extends ContextWrapper {
     ...
     * @param content
     */
    public void sendNotification(String title, String content, Class clazz) {
...
//        getmManager().notify(1, notification);
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Notification notification_26 = getNotification_26(title, content, clazz).build();
            getmManager().notify(1, notification_26);
        } else {
            LogUtils.i("发送了一条通知<26");
            Notification notification_25 = getNotification_25(title, content, clazz).build();
     ...
     * @return
     */
    public NotificationCompat.Builder getNotification_25(String title, String content, Class clazz) {
        ...
        style.bigPicture(BitmapFactory.decodeResource(getResources(), R.drawable.notification_icon_music, options));
       ...
       NotificationCompat.BigTextStyle style1 = new NotificationCompat.BigTextStyle();
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext)
                ...
                .setSmallIcon(R.drawable.notification_icon_info)
...
//        PendingIntent pendingIntent = PendingIntent.getBroadcast(mContext, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.O)
    public Notification.Builder getNotification_26(String title, String content, Class clazz) {
